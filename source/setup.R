...
# All that said, this is pretty ugly. Would be nice to have a more aesthetically pleasing palette that still meets the above needs, but that's not a priority for now.
