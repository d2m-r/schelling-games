## TODO: 
# 1. replace all kables with gt or other table package that doesn't break for no reason
# 2. check whether the workarounds used in the clean_meetup function are still necessary with current version of R
# 3. create an alternative to pie charts for dataviz elitists who insist pie charts are useless
